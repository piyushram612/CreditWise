      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">
            Is there a credit card you&apos;d like to see in our database? Let us know!
          </p>
          ...
          <form onSubmit={handleCardRequestSubmit}>
            ...
            <input 
              ...
              name="cardName" 
              type="text" 
              value={cardRequestName} 
              onChange={(e) => setCardRequestName(e.target.value)} 
              required 
              placeholder="e.g., HDFC Diners Club Black" 
            ...
            <button 
              type="submit" 
              disabled={isRequestLoading || !cardRequestName} 
              className="mt-4 w-full flex justify-center items-center bg-blue-500 text-white font-semibold px-4 py-2 rounded-lg shadow hover:bg-blue-600 transition-all duration-200 disabled:bg-blue-300 disabled:cursor-not-allowed"
            >
              {isRequestLoading ? 'Submitting...' : 'Submit Request'}
            </button>
            {requestMessage && (
              <p className="text-green-600 dark:text-green-400 text-sm mt-3 text-center">
                {requestMessage}
              </p>
            )}
          </form>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <form onSubmit={handleFeedbackSubmit}>
            ...
            <button 
              type="submit" 
              disabled={isFeedbackLoading || !feedbackText} 
              className="mt-4 w-full flex justify-center items-center bg-purple-500 text-white font-semibold px-4 py-2 rounded-lg shadow hover:bg-purple-600 transition-all duration-200 disabled:bg-purple-300 disabled:cursor-not-allowed"
            >
