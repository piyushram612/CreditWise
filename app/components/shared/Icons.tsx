...
const Cog6ToothIcon = () => <Icon path="M9.594 3.94c.09-.542.56-.94 1.11-1.153L12 2.25l1.313.537c.55.213 1.02.611 1.11 1.153.09.54-.09 1.09-.537 1.313L12 5.79l-1.886-.537c-.447-.223-.627-.773-.537-1.313zM13.5 12.75a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />;
