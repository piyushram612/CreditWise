...
import type { DashboardViewProps } from '@/app/types'

export default function DashboardView({ user, setActiveView, onAddCardClick }: { user: User | null, setActiveView: (view: string) => void, onAddCardClick: () => void }) {
